...
// local = the API answers only on 127.0.0.1; lan = also on the network, token required
export type ApiAccess = 'local' | 'lan'
...
export interface AppConfig {
  ...
  apiAccess: ApiAccess
  // Generated by the app the first time LAN access is enabled; never set by clients
